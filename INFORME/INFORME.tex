...
\noindent Es importante notar que el motor gira en sentido horario. Además, las mediciones fueron realizadas a 700 FPS.

\newpage
\section{RESULTADOS}

\noindent A continuación se mostrarán las fotos de una medición a 5826 RPM.
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.45\textwidth}
      ...
      \textwidth]{5826/0/0-1.png}
      \caption{Imagen 1 camara 0}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/1/1-1.png}
      \caption{Imagen 1 camara 1}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/0/0-2.png}
      \caption{Imagen 2 camara 0}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/1/1-2.png}
      \caption{Imagen 2 camara 1}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/0/0-3.png}
      \caption{Imagen 3 camara 0}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/1/1-3.png}
      \caption{Imagen 3 camara 1}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/0/0-4.png}
      \caption{Imagen 4 camara 0}
    \end{minipage}
    \begin{minipage}[b]{0.45\textwidth}
      \centering
      \includegraphics[width=0.8
      \textwidth]{5826/1/1-4.png}
      \caption{Imagen 4 camara 1}
    \end{minipage}
\end{figure}

\noindent Se puede observar que entre cada toma del mismo número, es decir 0-1 y 1-1, por ejemplo, se da un desfase de aproximadamente 30 grados, o 0.08 de vuelta, lo que equivale a 0.0001311 s.
\\ \\
Una incógnita que surgió es si son 30 grados o 390 grados, ya que no es posible determinarlo a simple vista. Pero si la cámara está funcionando a 700 FPS, quiere decir que se están sacando más fotos que vueltas por segundo, lo que ratifica los 30 grados.
\\ \\
Se realizaron 3 pruebas a distintas RPM, los resultados son los siguientes:
