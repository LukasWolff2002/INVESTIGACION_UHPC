...
#PUEDO CREAR LA LISTA CON 0 DEL TAMANO DE FOTOS FINALES
#EN VEZ DE TOMAR FOTO, MANDAR SENAL DE GRABAR VIDEO.
#GUARDAR FOTOS EN EL BUFFER

#HACER LISTAS DE 20 ELEMENTOS MAX, Y QUE SE VALLAN LLENANDO
#LISTAS CONCATENADAS
#INTERFEROMETRIA
